...
/**
  ...
  *
  * @checksum - cb3cf5947d46e1ed9e5716ab991c5615f2449a589e245f6718c5e2f1a3e65393
  * @variables - radius=rounded-full,accentColor=lime,colorTemperature=neutral,spacing=1.5,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=600,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded-full,swatchRadius=rounded-full
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "button__input": {
    ...
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "bg-lime-50": true,
    "hover:bg-lime-100": true,
    "dark:text-lime-500": true,
    "dark:bg-transparent": true,
    "dark:hover:bg-lime-50/5": true
  },
  "checkbox__decorator": {
    "rounded": true
  },
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-neutral-600": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-neutral-600": true,
  ...
  "range__input": {
    ...
    "group/input": true,
    "cursor-pointer": true,
    "[&::-webkit-slider-runnable-track]:bg-neutral-500/50": true,
    ...
    "[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-neutral-400": true,
    ...
    "[&::-moz-range-track]:bg-neutral-500/50": true,
  ...
  "submit__input": {
    ...
    "bg-lime-600": true,
    "!text-white": true,
    "active:text-lime-100": true,
    "active:bg-lime-700": true,
    "hover:bg-lime-700": true,
    "disabled:border-neutral-600": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-neutral-600": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "data-[is-active=true]:ring-lime-400": true,
    "aria-selected:ring-lime-400": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=progress]/wrapper:before:border-neutral-500": true,
    ...
    "group-data-[tab-style=progress]/wrapper:after:bg-neutral-500": true,
